    ...
    <>
      <div className="bg-[#1C0C26] h-max w-[100%] p-10 ">
        <div className=" h-28 flex  justify-between items-center">
          <button className="h-auto bg-gradient-to-r from-[#8061E9] to-[#EA8678]  text-white rounded py-3 px-4 flex">
            <img className="w-[200px]" src={logo} alt="" />

          </button>
          <button className=" h-max items-center gap-2 bg-gradient-to-r from-[#8061E9] to-[#EA8678] text-white rounded-full py-3 px-5 hidden sm:flex ">
        ...
        <div className=" mt-10 w-full flex justify-between lg:flex-row flex-col">
          <div className="lg:w-[40%] mt-7 w-full">
